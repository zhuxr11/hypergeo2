...
#include "../inst/include/hypergeo2.h"
#include <Rcpp.h>
#include <string>
#include <set>
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< const LogicalVector& >::type check_mode(check_modeSEXP);
    Rcpp::traits::input_parameter< const LogicalVector& >::type log(logSEXP);
    Rcpp::traits::input_parameter< const String& >::type backend(backendSEXP);
    rcpp_result_gen = Rcpp::wrap(genhypergeo_vec(U, L, z, prec, check_mode, log, backend));
    return rcpp_result_gen;
END_RCPP_RETURN_ERROR
}
RcppExport SEXP _hypergeo2_genhypergeo_vec(SEXP USEXP, SEXP LSEXP, SEXP zSEXP, SEXP precSEXP, SEXP check_modeSEXP, SEXP logSEXP, SEXP backendSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_hypergeo2_genhypergeo_vec_try(USEXP, LSEXP, zSEXP, precSEXP, check_modeSEXP, logSEXP, backendSEXP));
    }
...
RcppExport void R_init_hypergeo2(DllInfo *dll) {
